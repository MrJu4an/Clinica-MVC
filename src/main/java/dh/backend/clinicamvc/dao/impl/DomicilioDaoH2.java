...
public class DomicilioDaoH2 implements IDao<Domicilio> {
    ...
    public Domicilio registrar(Domicilio domicilio) {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                domicilioCreado = new Domicilio(id, domicilio.getCalle(), domicilio.getNumero(),
                        domicilio.getLocalidad(), domicilio.getProvincia());
            }

            LOGGER.info("Domicilio persistido: " + domicilioCreado);
    ...
    public Domicilio actualizar(Domicilio domicilio) {
        ...
        try {
            ...
            LOGGER.info("Domicilio actualizado: " + domicilioActualizado);
